...
import ResetPasswordForm from "./ResetPasswordForm.SuperAdmin";
import axios from 'axios';

function SuperAdminHeader({ dashboardType }: { dashboardType: string }) {
  ...
  const checkSession = async () => {
    try {
      ...
      const superadminUsername = sessionStorage.getItem("superadmin_username") ?? "";
