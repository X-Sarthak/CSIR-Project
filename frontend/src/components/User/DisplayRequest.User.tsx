        ...
        <div>
          ...
          <div className="flex min-h-screen">
            ...
            <div className="flex-1 border-l border-black bg-gray-400/50 flex flex-col">
              <>
                <div className="bg-white mt-2 border-t border-r px-1 py-1 border-b border-black flex items-center justify-between">
                  <h2 className="font-serif text-lg ml-2">Request Sent:</h2>
                    ...
                    <tbody>
                      {currentItems.length === 0 ? (
                        ...
                        currentItems.map((request) => (
                          <tr key={request.schedule_id} className="bg-white hover:bg-gray-100 text-medium">
                          <td className="px-4 py-2 text-center">{request.meeting_title}</td>
                          <td className="px-4 py-2 text-center">{request.meeting_username}</td>
                          <td className="px-4 py-2 text-center">{request.room_name}</td>
                          <td className="px-4 py-2 text-center">{request.authority_name}</td>
                          <td className="px-4 py-2 text-center">{request.formatted_meeting_date}</td>
                          <td className="px-4 py-2 text-center">{request.formatted_start_time}</td>
                          <td className="px-4 py-2 text-center">{request.formatted_end_time}</td>
                          <td className="px-4 py-2 text-center">{request.meeting_option}</td>
                          <td className="px-4 py-2 text-center">
                            {request.meeting_link ? (
                              <a
                                href="#"
                                onClick={() => handleLinkClick(request.meeting_link)}
                          ...
                          <td className="px-4 py-2 text-center">
                            <button
                              onClick={() => handleCancelRequest(request.schedule_id)}
