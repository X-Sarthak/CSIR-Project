...
import ResetPasswordForm from './ResetPasswordForm.Meeting'; // Import the ResetPasswordForm component
import axios from 'axios';

function MeetingHeader({ dashboardType }: { dashboardType: string }) {
    ...
    <div className="bg-sky-600 font-serif text-white">
      <div className='mx-6 ml-18 px-4 py-4 flex items-center justify-between'>
        ...
        <div className='relative'>
          ...
          {isDropdownOpen && (
            <div ref={dropdownRef} className='absolute right-0 mt-2 bg-white shadow-md rounded-md z-10' style={{ width: 'max-content' }}>
